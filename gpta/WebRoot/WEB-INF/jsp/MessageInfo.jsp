...
<!--                   </li> -->
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <c:forEach var="msglist" items="${msglist}">
                      <tr>
                        <td>${msglist.spotid}</td>
                        <td>${msglist.userid}</td>
                        <td>${msglist.date}</td>
                        <td style="width:40%">${msglist.content}</td>
                        <td><a href="message.do?m=delmessagebyid&id=${msglist.id }"  onClick="return confirm('确认删除?');">删除</a></td>
                      </tr>
                     </c:forEach>
                    </tbody>
    ...
    <script type="text/javascript">
 	$(function () {
 		...
 		if(msg!=""){
 			alert(msg);
 			window.location.href="message.do?m=init";
 		}
        $("#example1").dataTable();
        $('#example2').dataTable({
          "bPaginate": true,
